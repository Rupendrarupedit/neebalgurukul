...
public class Question {
    ...
    private Set<Question_Option> question_optionSet;
   ...
   public Set<Question_Option> getQuestion_optionSet() {
        return question_optionSet;
    }

    public void setQuestion_optionSet(Set<Question_Option> question_optionSet) {
